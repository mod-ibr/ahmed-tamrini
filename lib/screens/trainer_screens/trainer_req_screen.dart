...
class _TrainerRequestScreenState extends State<TrainerRequestScreen> {
  ...
  late final contact1Controller = TextEditingController();
  late final contact2Controller = TextEditingController();
  late final contact3Controller = TextEditingController();
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        extendBody: true,
        appBar: globalAppBar(tr('subscribe_as_trainer')),
                        ...
                        onPressed: () async {
                          try {
                            ...
                            if (descriptionController.text.isNotEmpty &&
                              ...
                              trainerProvider.subscribeAsTrainer(widget.user);
